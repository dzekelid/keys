...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/keys/master/_listings/context-io/apis.md
...
- name: Context.IO - Get Oauth Provers Key
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/keys/master/_listings/context-io/oauth-providerskey-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/keys/master/_listings/context-io/oauth-providerskey-get-openapi.md
- name: Context.IO - Delete Oauth Provers Key
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/keys/master/_listings/context-io/oauth-providerskey-delete-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/keys/master/_listings/context-io/oauth-providerskey-delete-openapi.md
- name: Context.IO - Delete Oauth Provers Key
  x-api-slug: oauth-providerskey-delete
  description: Removes a given OAuth provider.
  image: http://kinlane-productions.s3.amazonaws.com/screen-capture-api/172-context-io.jpg
