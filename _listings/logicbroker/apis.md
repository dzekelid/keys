...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/keys/master/_listings/logicbroker/apis.md
...
- name: CommerceAPI - Retrieve acknowledgement status
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/keys/master/_listings/logicbroker/apiv1acknowledgementslogicbrokerkeystatus-get-openapi.md
- name: CommerceAPI - Retrieve acknowledgement status
  x-api-slug: apiv1acknowledgementslogicbrokerkeystatus-get
  description: Request rate limited to 10 requests per second with bursts up to 100
    requests.
...
- name: CommerceAPI - Update acknowledgement status
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/keys/master/_listings/logicbroker/apiv1acknowledgementslogicbrokerkeystatusstatus-put-openapi.md
- name: CommerceAPI - Update acknowledgement status
  x-api-slug: apiv1acknowledgementslogicbrokerkeystatusstatus-put
  description: Request rate limited to 10 requests per second with bursts up to 100
    requests.
...
- name: CommerceAPI - Returns the invoice with the specified key.
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/keys/master/_listings/logicbroker/apiv1invoiceslogicbrokerkey-get-openapi.md
x-common:
- type: x-blog-rss
