...
- name: Azure IoT Hub API Iot Hub Resource Get Keys For Key Name
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/keys/master/_listings/azure-iot-hub/subscriptions-subscriptionid-resourcegroups-resourcegroupname-providers-microsoft-devices-iothubs-resourcename-iothubkeys-keyname-listkeys-post-postman.md
x-common:
