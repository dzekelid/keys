...
- name: Heroku - Parameters User Keys
  x-api-slug: userkeys-parameters
...
- name: Heroku - Parameters User Keys Key
  x-api-slug: userkeyskey-parameters
...
- name: Heroku - Parameters Application Config Variables Key
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/keys/master/_listings/heroku/appsappconfig-varskey-parameters-openapi.md
- name: Heroku - Delete Application Config Variables Key
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/keys/master/_listings/heroku/appsappconfig-varskey-delete-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/keys/master/_listings/heroku/appsappconfig-varskey-delete-openapi.md
- name: Heroku - Parameters User Keys Key
  x-api-slug: userkeyskey-parameters
  description: Parameters user keys key.
  image: http://kinlane-productions.s3.amazonaws.com/screen-capture-api/211-heroku.jpg
