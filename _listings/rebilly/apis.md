...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/keys/master/_listings/rebilly/apis.md
specificationVersion: "0.14"
apis:
- name: Rebilly - Retrieve a list of api keys
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/keys/master/_listings/rebilly/apikeys-get-openapi.md
- name: Rebilly - Create an api key
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/keys/master/_listings/rebilly/apikeys-post-openapi.md
- name: Rebilly - Delete api key
  x-api-slug: apikeysid-delete
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/keys/master/_listings/rebilly/apikeysid-delete-openapi.md
- name: Rebilly - Retrieve api key
  x-api-slug: apikeysid-get
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/keys/master/_listings/rebilly/apikeysid-get-openapi.md
- name: Rebilly - Create or update api key with predefined ID
  x-api-slug: apikeysid-put
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/keys/master/_listings/rebilly/apikeysid-put-openapi.md
- name: Rebilly - Create or update api key with predefined ID
  x-api-slug: apikeysid-put
  description: Create or update api key with predefined identifier string
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/rebilly.png
