...
- name: AWS Identity and Access Management API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/keys/master/_listings/aws-identity-and-access-management/action-getcontextkeysforprincipalpolicy-get.md
x-common:
- type: x-change-log
